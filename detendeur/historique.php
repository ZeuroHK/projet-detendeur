...
<head>
    ...
    <title>Détendeur - Historique</title>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"
     ...
     <style>
        ...
        .customgraph{
            background-color: rgba(180, 255, 255, 1);; /* Couleur de fond du conteneur du graphique */
            padding: 20px;
            border-radius: 10px;
            max-width: 1100px;
...
<body>
    <div class="container">
        ...
        <div class="row mt-4 mb-4 d-flex justify-content-center align-items-center custom-row-background rounded-4">
            <form action="seance.php" method="post">
                <div class="">
                    <ion-icon name="person-circle-outline"></ion-icon>
                    <label for="username">Insérez l'ID du graphique que vous voulez voir :</label>
                    <input class="rounded form-control" type="number" id="seance" name="seance">
                    <center><button class="login-button ms-2 me-2 rounded-5" type="submit">Accèder au graphique</button></center>
                </div>
            </form>
            <br>
        </div>
        ...
        <div class="row">
            ...
            <table class="table table-hover mt-3">
                ...
                <?php
                    ...
                    $table = "Seances"; // Remplacez par le nom réel de votre table
                    $requete = "SELECT * FROM `$table` WHERE `id-utilisateur`= $coluserid";
                    ...
                    if ($resultat) 
                    {
                        ...
                        while ($row = mysqli_fetch_assoc($resultat)) 
                        {
                            ...
                            $dateEuropeen  = $date->format('d-m-Y | H:i');
